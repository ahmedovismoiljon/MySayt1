...
function CurrencyConvertar(){
    const [rates, setRates] = useState([]);
    const [amout, setAmount]=useState(1);
    const [fromCurrency, setFromCurrency] = useState('USZ');
    ...
    return(
        <div style={{ padding: '30px', maxWidth: '500px', margin: '0 auto', background: 'rgba(0, 0, 0, 0.1)',
            ...
            <div style={{marginTop: '30px', textAlign: 'center', padding: '20px', background:'none', borderRadius: '10px'}}>
...
export default CurrencyConvertar;
